...
pub mod stream {
    ...
    assert_impl!(Select<(), (), ExitWhenBothFinished>: Send);
    assert_not_impl!(Select<*const (), (), ExitWhenBothFinished>: Send);
    assert_not_impl!(Select<(), *const (), ExitWhenBothFinished>: Send);
    assert_impl!(Select<(), (), ExitWhenBothFinished>: Sync);
    assert_not_impl!(Select<*const (), (), ExitWhenBothFinished>: Sync);
    assert_not_impl!(Select<(), *const (), ExitWhenBothFinished>: Sync);
    assert_impl!(Select<(), (), ExitWhenBothFinished>: Unpin);
    assert_not_impl!(Select<PhantomPinned, (), ExitWhenBothFinished>: Unpin);
    assert_not_impl!(Select<(), PhantomPinned, ExitWhenBothFinished>: Unpin);
